...
// ─── Exact defaults from BreathDearMedusae ───────────────────────────────────
...
// ─── Particles Scene (exact port of Medusae.jsx from the repo) ───────────────
...
// ─── Root component — exact same structure as repo's Medusae component ────────
const MedusaeBackground = ({ config, style, className }) => {
  const merged = useMemo(() => mergeConfig(config), [config]);
